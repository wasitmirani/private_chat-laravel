                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="pills-chat" role="tabpanel" aria-labelledby="pills-chat-tab">
                        ...
                        <div>
                            ...
                            <div class="px-2">
                                <h5 class="mb-3 px-3 font-size-16">Online</h5>
                                ...
                                <div class="chat-message-list" data-simplebar="">
                                    ...
                                    <ul class="list-unstyled chat-list chat-user-list">
                                        <!-- <li>
                                            ...
                                            <li     class="unread"  v-for="user in users" :key="user.id">
                                            <a role="button" v-if="user.user_id!=auth_user_id" @click="get_current_user(user)">
                                                <div class="media">
                                                    <div class="chat-user-img online  align-self-center mr-3">
                                                        <vue-letter-avatar :name="user.name" size='40' :rounded=true class="rounded-circle avatar-xs" />
<!--
                                    ...
                                    <div class="conversation-list" id>
                                        <div class="chat-avatar">
                                               <span v-if="auth_user_id===message.sender_id">
                                                 ...
                                                 <span v-else>
                                                     <vue-letter-avatar :name="activeFriend.name" size='40' :rounded=true class="rounded-circle avatar-xs" />
      ...
      axios.post('/api/send/message/'+this.auth_user_id+'/'+this.activeFriend.user_id,frmdata).then((res)=>{
        ...
        mounted() {
         ...
         window.onbeforeunload = () => {
                    ...
                    socket.emit('leaved', this.activeUser)
                }
